...
from reinvent_chemistry import Conversions, PhysChemDescriptors
from unittest_reinvent.fixtures.test_data import ASPIRIN, CELECOXIB, IBUPROFEN, PENTANE, METAMIZOLE, \
    METHYLPHEMYL_FRAGMENT, GENTAMICIN
...
class TestPhysChemDescriptors(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.smiles_list = [ASPIRIN, CELECOXIB, IBUPROFEN, PENTANE, METAMIZOLE, METHYLPHEMYL_FRAGMENT, GENTAMICIN]
        self.expected_values = dict(
            ...
            tpsa=[63.6, 77.98, 37.3, 0., 84.54, 0., 199.73],
