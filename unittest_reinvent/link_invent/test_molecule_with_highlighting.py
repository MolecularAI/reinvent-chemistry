...
from unittest_reinvent.fixtures.test_data import METAMIZOLE, METAMIZOLE_SCAFFOLD, METAMIZOLE_DECORATIONS
...
class TestMoleculeWithHighlighting(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.parts_list = [self.tokens.ATTACHMENT_SEPARATOR_TOKEN.join([METAMIZOLE_SCAFFOLD, METAMIZOLE_DECORATIONS])]
        self.parts_list_2 = [self.tokens.ATTACHMENT_SEPARATOR_TOKEN.join([METAMIZOLE_DECORATIONS, METAMIZOLE_SCAFFOLD])]
